# PROJECT FROM https://github.com/logxseven/Cash-Drawer-Opener


# STEPS
#
#  pip install PyQt5 pyserial pynput 
#
#   or
#
...
config = open(os.path.join(BASE_DIR, './plugin/cashDrawer/info.conf'), 'r')
